...
namespace BlackBox.FluentPath {
    ...
    public class Path {
        ...
        public Path Parent {
            get {
                var upStr = System.IO.Path.GetDirectoryName(this.ToString());
                if (upStr == null) return this;
                return new Path(upStr, this);
            }
        }
        ...
        public FileSystemSecurity AccessControl {
            get {
                return IsDirectory ?
                                       (FileSystemSecurity)Directory.GetAccessControl(_path) :
        ...
        public PathCollection GetDirectories(string searchPattern, bool recursive) {
            ...
            return new PathCollection(
                ...
                new PathCollection(new string[] {_path}));
        }
        ...
        public PathCollection GetDirectories(Predicate<Path> predicate, bool recursive) {
            ...
            return new PathCollection(result, new PathCollection(new string[] { _path }));
        }
