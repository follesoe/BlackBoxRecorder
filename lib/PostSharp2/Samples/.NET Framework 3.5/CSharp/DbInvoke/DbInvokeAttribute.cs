...
namespace DbInvoke
{
    ...
    public sealed class DbInvokeAttribute : ImplementMethodAspect
    {
        ...
        /// <remarks>
        public override void OnExecution( MethodExecutionArgs aspectArgs )
        {
            // Get a connection.
            ...
            command.CommandText = aspectArgs.Method.Name;
            command.CommandType = CommandType.StoredProcedure;

            // Add parameters.
            ParameterInfo[] methodParameters = aspectArgs.Method.GetParameters();
            for ( int i = 0 ; i < methodParameters.Length ; i++ )
            {
                ...
                {
                    commandParameter.Value = aspectArgs.Arguments[i];
                }
